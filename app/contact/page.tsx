      ...
      <main>
        ...
        <section className="py-24 px-6 border-t border-white/8">
          <div className="max-w-6xl mx-auto flex flex-col gap-8">
            <div>
              <p className="text-white/55 text-sm mb-2">{c.info.email_label}</p>
              <a
            ...
            <div>
              <p className="text-white/55 text-sm mb-2">{c.info.location_label}</p>
              <p className="text-white text-xl">{c.info.location}</p>
            </div>
          </div>
        </section>
      </main>
